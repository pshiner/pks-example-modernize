...
--	CONSTRAINT EX_LOAN_PK PRIMARY KEY(FK_PROGRAM_CODE,C_CODE),
--	CONSTRAINT EX_LOAN_CODE_UC UNIQUE (C_CODE)
);

INSERT INTO EX_LOAN (FK_PROGRAM_CODE, C_CODE, FK_BORROWER_CODE, N_LOAN_NUMBER, C_STATUS, C_NAME, 
		C_DESCRIPTION, BD_INTEREST_RATE, BD_ORIGINAL_PRINCIPAL, FK_APP_USER) VALUES
	('AAA', 'XYZ-1', 'B002', 1, 'D', 'Boat',       'Going to buy a boat.',       3.75,   15500,  'peter' ),
	('AAA', 'XYZ-2', 'B002', 2, 'D', 'House',      'Going to buy a house.',      3.5575, 554300, 'peter' ),
	('AAA', 'ABC-3', 'B002', 3, 'D', 'Truck',      'Going to buy a truck.',      4.875,  15500,  'martin'),
	('AAA', 'XYZ-4', 'B002', 4, 'D', 'Motorcycle', 'Going to buy a motorcycle.', 2.75,   15500,  'martin'),
	('AAA', 'ZZZ-5', 'B002', 5, 'D', 'Plane',      'Going to buy a plane.',      8.75,   675500, 'peter' );
...
INSERT INTO EX_PERIODIC_PAYMENT (
	FK_PROGRAM_CODE, FK_LOAN_CODE, N_PMT_SEQUENCE, D_PMT_DATE, D_PMT_ADJUSTED_DATE,
	BD_PMT_PRINCIPAL, BD_PMT_INTEREST, BD_PMT_CAP_INTEREST, BD_BAL_PRINCIPAL, BD_BAL_CAP_INTEREST) VALUES
	('AAA', 'XYZ-2',  1, '2024-08-05', '2024-08-05', 325, 645, 0, 15450, 0 ),
	('AAA', 'XYZ-2',  2, '2024-09-05', '2024-09-05', 325, 645, 0, 15450, 0 ),
	('AAA', 'XYZ-2',  3, '2024-10-05', '2024-10-05', 325, 645, 0, 15450, 0 ),
	('AAA', 'XYZ-2',  4, '2024-11-05', '2024-11-05', 325, 645, 0, 15450, 0 ),
	('AAA', 'XYZ-2',  5, '2024-12-05', '2024-12-05', 325, 645, 0, 15450, 0 ),
	('AAA', 'XYZ-2',  6, '2025-01-05', '2025-01-05', 325, 645, 0, 15450, 0 ),
	('AAA', 'XYZ-2',  7, '2025-02-05', '2025-02-05', 325, 645, 0, 15450, 0 ),
	('AAA', 'XYZ-2',  8, '2025-03-05', '2025-03-05', 325, 645, 0, 15450, 0 ),
	('AAA', 'XYZ-2',  9, '2025-04-05', '2025-04-05', 325, 645, 0, 15450, 0 ),
	('AAA', 'XYZ-2', 10, '2025-05-05', '2025-05-05', 325, 645, 0, 15450, 0 ),
	('AAA', 'XYZ-2', 11, '2025-06-05', '2025-06-05', 325, 645, 0, 15450, 0 );
